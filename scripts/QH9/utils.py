...
def number_to_6bit_list(number):
    # Check if the number is within the valid range
    if number < 0 or number > 63:
        raise ValueError("Number out of range. Must be between 0 and 63 inclusive.")

    # Convert the number to a binary string and pad it with leading zeros to make it 6 bits
